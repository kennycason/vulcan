If InitSprite()
Else
  MessageRequester("Vulcan I","DirectX v.7 or later was unable to be initialized",0)
  End 
EndIf 
If InitKeyboard() 
Else 
  MessageRequester("Vulcan I","A keyboard was unable to be initialized!",0)
  End 
EndIf 
...
If InitSound()
  playsound = 1
Else
  MessageRequester("Vulcan I","Sound is unavailable on this computer",0)
  playsound = 0
EndIf
...
#Max_Bullets = 35
#LevelImage = 500
#LevelDisplayImage = 549
#Background = 0
#LevelSound = 0
screenX = 800
screenY = 600
;- Openwindow  or screen
;If OpenScreen(screenX, screenY, 32, "vulcan I")
If OpenWindow(0,0,0,screenX,screenY,"Vulcan I",#PB_Window_SystemMenu | #PB_Window_MinimizeGadget| #PB_Window_TitleBar) And OpenWindowedScreen(WindowID(0),0,0,screenX,screenY,1,0,0)
UseOGGSoundDecoder()
UseJPEGImageDecoder()
UsePNGImageDecoder()
 ...
 For L=65 To 90
   l$ = Chr(L)
   LoadSprite(k,file$+"font/"+l$+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
   k+1
 Next 


 For k=827 To 836
   LoadSprite(k,file$+"font/"+Str(k-827)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next 
 
 ;*************************************
 LoadSprite(501, file$+"Title.jpg",0)
 LoadSprite(502, file$+"Title2.jpg",0)
 LoadSprite(510, file$+"crosshair.png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 LoadSprite(511, file$+"crosshair2.png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
  For k = 2 To 4
 ...
 DataSection     ; ********* a includebinary file bigger .exe but noone can steal stuff :)
   weapon:
   IncludeBinary "sound/wav/weapon_1.wav"
   weapon2:
   bullethit:
   IncludeBinary "sound/wav/bullethit.wav"
   bullethit2:
   label:
   IncludeBinary "sound/ogg/level_1.ogg"
   label2:
...
; CatchSound(31, ?label3, ?label4 - ?label3) 
 ...
 DataSection
   ...
   level2:
   IncludeBinary "sprites/level/level_2.jpg"
   level3:
   IncludeBinary "sprites/level/level_3.jpg"
   level4:
   IncludeBinary "sprites/level/level_4.jpg"
   level5:
   IncludeBinary "sprites/level/level_5.jpg"
   level6:
   IncludeBinary "sprites/level/level_6.jpg"
   level7:
   IncludeBinary "sprites/level/level_7.jpg"
   level8:
   IncludeBinary "sprites/level/level_8.jpg"
 EndDataSection 
 
 For k=1 To 3
   LoadSprite(k,file$+"ship"+Str(k)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next
 
 For k=4 To 6
   LoadSprite(k,file$+"ship"+Str(k-3)+"_down.png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)  
 Next 
   
 For k=7 To 9
   LoadSprite(k,file$+"ship"+Str(k-6)+"_up.png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next   
 
 For k = 495 To 497
   LoadSprite(k,file$+"iship_"+Str(k - 494)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next 
 
 For k = 498 To 499
   LoadSprite(k,file$+"icon_"+Str(k-497)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next 

 For k=250 To 255
   LoadSprite(k,file$+"enemy_1_"+Str(k-249)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next
 
 For k=256 To 261
 LoadSprite(k,file$+"enemy_2_"+Str(k-255)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next
 
 For k=262 To 268
   LoadSprite(k,file$+"enemy_3_"+Str(k-261)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next
 
 For k=269 To 271
   LoadSprite(k,file$+"asteriod_1_"+Str(k-268)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next

 For k=272 To 278
   LoadSprite(k,file$+"enemy_4_"+Str(k-271)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next
 
 For k=279 To 282
   LoadSprite(k,file$+"enemy_5_"+Str(k-278)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next
 
 For k=283 To 291
   LoadSprite(k,file$+"enemy_6_"+Str(k-282)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next
 
 For k = 300 To 301
   LoadSprite(k,file$+"boss_1_"+Str(k-299)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next 
 
 For k = 302 To 312
   LoadSprite(k,file$+"boss_2_"+Str(k-301)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next 
 
 For k = 313 To 314
   LoadSprite(k,file$+"boss_3_"+Str(k-312)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next 

 For k = 315 To 318
   LoadSprite(k,file$+"boss_4_"+Str(k-314)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next 
 
  For k=319 To 328
   LoadSprite(k,file$+"enemy_7_"+Str(k-318)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next
 
 For k=10 To 15
   LoadSprite(k,file$+"bullet_"+Str(k-9)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next 

 For k=16 To 23
   LoadSprite(k,file$+"explosion_"+Str(k-15)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next

 For k=150 To 155
   LoadSprite(k,file$+"bullet_back_"+Str(k-149)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next 

 For k=160 To 165
   LoadSprite(k,file$+"bullet_left_"+Str(k-159)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next
 
 For k=170 To 175
   LoadSprite(k,file$+"bullet_right_"+Str(k-169)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next 
 
 For k=400 To 407
   LoadSprite(k,file$+"Beam_"+Str(k-399)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next
 
 For k=480 To 482
   LoadSprite(k,file$+"charging_"+Str(k-479)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next
 
 For k=422 To 424  
   LoadSprite(k,file$+"Beam_back_"+Str(k-420)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next
 
 For k=443 To 443  
   LoadSprite(k,file$+"Beam_left_"+Str(k-440)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next
 
 For k=463 To 463  
   LoadSprite(k,file$+"Beam_right_"+Str(k-460)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next
 
 For k=200 To 207
   LoadSprite(k,file$+"enemy_bullet_"+Str(k-199)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next 
 
 For k=25 To 34
   LoadSprite(k,file$+"item_"+Str(k-24)+".png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next
 
 For k=40 To 42
   LoadSprite(k,file$+"ship"+Str(k-39)+"_forward.png",#PB_Sprite_AlphaBlending | #PB_Sprite_PixelCollision)
 Next
 ;*****************
...
Else
 MessageRequester("error","a 800*600 screen can not be opened!",0)
End
EndIf 
...
MovePlayers:
  ...
  If KeyboardPushed(#PB_Key_R) Or ( joystick = 1 And JoystickButton(0, 9) )
    FakeReturn 
    Gosub saveHiscore
    reset = 1
    Goto Begin
  ...
  If KeyboardPushed(#PB_Key_Left) Or KeyboardPushed(#PB_Key_A) Or (joystick = 1 And JoystickAxisX(0) = -1 )
  ...
  If KeyboardPushed(#PB_Key_Right) Or KeyboardPushed(#PB_Key_D) Or (joystick = 1 And JoystickAxisX(0) = 1 )
  ...
  If KeyboardPushed(#PB_Key_Up) Or KeyboardPushed(#PB_Key_W) Or (joystick = 1 And JoystickAxisY(0) = -1 )
  ...
  If KeyboardPushed(#PB_Key_Down) Or KeyboardPushed(#PB_Key_S) Or (joystick = 1 And JoystickAxisY(0) = 1 )
  ...
  If KeyboardPushed(#PB_Key_X) Or (joystick = 1 And JoystickButton(0, 1) )
    Gosub SpeedDown
  EndIf
  
  If KeyboardPushed(#PB_Key_LeftAlt) Or KeyboardPushed(#PB_Key_K) Or (joystick = 1 And JoystickButton(0, 7) )  Or (joystick = 1 And JoystickButton(0, 8))
    If charge = 0
      Gosub WeaponCycle
    EndIf 
  EndIf 
...
If DeadDelay = 0
  If BulletDelay = 0
     If KeyboardPushed(#PB_Key_Space) Or KeyboardPushed(#PB_Key_J) Or (joystick = 1 And JoystickButton(0, 3) )
        Gosub Shoot
     EndIf 
  EndIf  
...
EndIf 
  ...
  Repeat
    Repeat : Until WindowEvent() = 0
    ExamineKeyboard()
    If KeyboardReleased(#PB_Key_Return) ;pause
      If Paused = 0
        Gosub DrawMenu
        BitmapText("PAUSE",320,280)
        FlipBuffers()
...
EndIf 
  ...
  If Random(1000) < enemy()\shotChance And ListSize(enemyBullet()) < #Max_bullets
...
If do = 1
  ...
  If boss = 0
    ...
    EndIf
    If IsImage(#LevelDisplayImage)
      FreeImage(#LevelDisplayImage)
    EndIf
    ;LoadSprite(#LevelImage,file$+"level\jpg\"+"level_"+Str(levelimage-500)+".jpg",0 )
    If lvl = 1
      CatchSprite(#LevelImage, ?level1, #PB_Sprite_PixelCollision)
      CatchImage(#LevelDisplayImage, ?level1)
    ElseIf lvl = 2
      CatchSprite(#LevelImage, ?level2, #PB_Sprite_PixelCollision)
      CatchImage(#LevelDisplayImage, ?level2)
    ElseIf lvl = 3
      CatchSprite(#LevelImage, ?level3, #PB_Sprite_PixelCollision)
      CatchImage(#LevelDisplayImage, ?level3)
    ElseIf lvl = 4
      CatchSprite(#LevelImage, ?level4, #PB_Sprite_PixelCollision)
      CatchImage(#LevelDisplayImage, ?level4)
    ElseIf lvl = 5
      CatchSprite(#LevelImage, ?level5, #PB_Sprite_PixelCollision)
      CatchImage(#LevelDisplayImage, ?level5)
    ElseIf lvl = 6
      CatchSprite(#LevelImage, ?level6, #PB_Sprite_PixelCollision)
      CatchImage(#LevelDisplayImage, ?level6)
    ElseIf lvl = 7
      CatchSprite(#LevelImage, ?level7, #PB_Sprite_PixelCollision)
      CatchImage(#LevelDisplayImage, ?level7)
    ElseIf lvl = 8
      CatchSprite(#LevelImage, ?level8, #PB_Sprite_PixelCollision)
      CatchImage(#LevelDisplayImage, ?level8)
    EndIf
...
DrawMenu:
      ...
      StartDrawing(ScreenOutput())
        ...
        DrawText(10,505,"HI SCORE "+Str(hiscore))
        DrawText(10,520,"SCORE "+Str(score))
        DrawText(10,535,"LEVEL "+Str(lvl))
        If lives >= 0
          DrawText(90,565,"x "+Str(lives))
        Else
          DrawText(90,565,"x 0")         ; dont want it to show -1
        EndIf
        DrawText(150,570,"POWER "+Str(weaponselect-10))
        DrawText(320,570,"SPEED ")
        DrawText(320,505,"MODE:")
        If mode = 1
          DrawText(380,505,"Easy")
        ElseIf mode = 2
          DrawText(380,505,"Normal")
        ElseIf mode = 3
          DrawText(380,505,"Hard")
        Else
          DrawText(380,505,"Super Ultra Mega Hard")
        EndIf

        DrawText(320,520,"HIT%")
        If hit+miss = 0
          t.f = 0
        Else
          t.f = (hit/(hit+miss)*100)
        EndIf
        DrawText(380,520,Str(Round(t,0)))

        If beam0=1
          DrawText(250,510,"Phazor")
        EndIf

        If beam1=1
          DrawText(250,525,"Homing")
        EndIf
        If beam2=1
          DrawText(250,540,"Plasma")
        EndIf
        If beam4>=1
          DrawText(250,570,"Charge")
        EndIf
        If beam3>=1
          DrawText(250,555,"Vulcan")       ; beam 3 and 4 are out of order and ill consider fixing all the trash later
        EndIf
        DrawText(240,510 + beamselect*15,"*")
      StopDrawing()
...
DrawBackground:
      ...
      ; Start tiles at ScrollX/ScrollY directly (already clamped to -backgroundWidth..0)
      ; so no tile origin goes further than one tile width off-screen
      x = ScrollX
      While x < screenX
        y = ScrollY
        While y < screenY
          DisplaySprite(background, x, y)
          y + backgroundHeight
        Wend
        x + backgroundWidth
      Wend
      
      ScrollY+backgroundspeedy
      If ScrollY < -backgroundHeight
        ScrollY + backgroundHeight
      EndIf
      ...
      EndIf
      ; Draw level terrain on top of background, underneath all sprites
      If IsImage(#LevelDisplayImage)
        StartDrawing(ScreenOutput())
        DrawImage(ImageID(#LevelDisplayImage), levelx, levely)
        StopDrawing()
      EndIf
Return
...
DrawTitleScreen:
  ...
  While exit = 0
    ...
    If KeyboardPushed(#PB_Key_Return) Or KeyboardPushed(#PB_Key_Space) Or KeyboardPushed(#PB_Key_J) Or KeyboardPushed(#PB_Key_K) Or (joystick = 1 And JoystickButton(0, 3))
...
If OpenFile(0, "vulcan.vc")
  WriteLong(0, (hiscore-1234567890))
  WriteLong(0, (unlock-1234567890))
  WriteLong(0, (gameBeat-1234567890))
  WriteLong(0, (maxEnemKilled-1234567890))
  WriteString(0, hiPlayer$)
  CloseFile(0)
EndIf 
...
inputName:
  ...
  While exit = 0
    ...
    If joystick = 1
      ExamineJoystick(0)
    EndIf
    If KeyboardPushed(#PB_Key_Return) Or (joystick = 1 And JoystickButton(0, 2) )
      exit = 1
    EndIf 
    If KeyboardPushed(#PB_Key_Back) Or (joystick = 1 And JoystickButton(0, 1) )
      hiPlayer$ = Mid(hiPlayer$,1,Len(hiPlayer$)-1)
      Delay(200)
    EndIf 
    If KeyboardPushed(#PB_Key_Space) Or (joystick = 1 And JoystickButton(0, 3) )
      If Len(hiPlayer$) < 6
        hiPlayer$+Mid(string$,k,1)
        Delay(200)
      EndIf
    EndIf 
    If KeyboardPushed(#PB_Key_Left) Or (joystick = 1 And JoystickAxisX(0) = -1 ) Or (joystick = 1 And JoystickButton(0, 7) )
      k-1 
      Delay(100)
    EndIf 
    If KeyboardPushed(#PB_Key_Right) Or (joystick = 1 And JoystickAxisX(0) = 1 ) Or (joystick = 1 And JoystickButton(0, 8) )
      k+1
      Delay(100)
    EndIf 
  Wend 
...
initJoystick:
  ...
  EndIf 
Return 
; IDE Options = PureBasic 6.40 beta 5 - C Backend (MacOS X - arm64)
; CursorPosition = 2338
; FirstLine = 2325
; Folding = -
; EnableXP
